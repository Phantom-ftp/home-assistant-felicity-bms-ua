...
Цей проєкт дозволяє інтегрувати моніторинг BMS літієвих акумуляторів Felicity Solar (перевірено на FelicityESS LiFePO4 LPBF24200-A) у систему розумного дому Home Assistant за допомогою протоколу CAN.
...
> [!WARNING]
>Для комутації з CAN-трансивером використовуємо піни 1, 3, 4 (НЕ 7, 8 - з них ви данні не отримаєте), решту невикористовуваних пінів або не обтискайте або після обрізки заізолюйте щоб вони не коротили один до одного.  
